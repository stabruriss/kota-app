...
const initial: BbsSyncView = {
  ...
  phase: 'idle', progress: null, lastSuccessfulAt: '2026-09-12T06:00:00Z', error: null, controlRecoverable: false,
};
...
const actions = {
  ...
  start: async () => change({ ...state, phase: 'syncing', progress: { completed: 4, total: 12 } }),
...
function Preview() {
  ...
  return <div style={{ padding: 32 }}>
    ...
    <label>Preview state <select aria-label="Preview state" onChange={event => {
      ...
      <option>busy</option><option>unknown</option><option>identity</option></select></label>
