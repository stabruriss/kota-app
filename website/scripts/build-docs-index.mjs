...
function referenceSection() {
  return `
    <section class="sect">
      <div class="sect-head">
        <div class="sect-title">REFERENCE</div>
        <span class="sect-count">1 PAGE</span>
      </div>
      <div class="doclist">
        <article class="doc-card">
          <div class="chips">
            <span class="chip type">CLI MATRIX</span>
            <span class="chip">UPDATED AT · 2026-08-02</span>
          </div>
          <h2 class="doc-title"><a href="/docs/cli-host-compatibility/">CLI Host Compatibility</a></h2>
          <p class="abstract">Version-pinned evidence for six hosted CLIs: launch, resume, native records, and work-state signals.</p>
          <div class="doc-foot">
            <a class="read" href="/docs/cli-host-compatibility/">Read&nbsp;→</a>
          </div>
        </article>
      </div>
    </section>`;
